class Utils {
	...
	public static sightWords = "的一是了我不人在他有这个上们来到时大地为子中你说生国年着就那和要她出也得里后自以会家可下而" +
	...
	public static ColorGrey(obj: any, isShow: boolean = true, isTouch: boolean = true): void {
		...
		if (isTouch) obj["touchEnabled"] = !isShow;
		if (isShow) {
	...
	public static getWeek(date: string): number {
	...
	public static loadHeadImg(url: string, headimg: any): void {
	...
	private static inviteCodeSoureString: string = "6E?tGH,q9>;4QSmA:*nJxB~W3^a+2PV#Mu%XYCjr8sUDk!hiNZF$L=Tp.c5e<w@bvf1Kg7yRdz";
	private static inviteCode: string = "";

	

	public static decodeInviteCode(inviteCode: string): any {

		let ids: string = inviteCode.substr(5, 7);
		let teamids: string = inviteCode.substr(0, 5);
	...
	public static addBtnEvent(btn: any, cb: Function, that: any, obj: any, type: number = 1, sound: string = '', delay: number = 0): Function {
		if (delay == 0) {
			delay = 200;
		}
	...
	public static convertToChinaNum(num) {
